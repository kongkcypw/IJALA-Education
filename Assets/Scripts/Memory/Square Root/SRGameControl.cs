...
public class SRGameControl : MonoBehaviour
{
    GameObject token;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 11 ; i++)
        {
            ...
            var temp = Instantiate(token, new Vector3(
                ...
                Quaternion.identity);
            temp.GetComponent<SRMainToken>().faceIndex = faceIndexes[shuffleNum];
        ...
        token.GetComponent<SRMainToken>().faceIndex = faceIndexes[0];
    }
