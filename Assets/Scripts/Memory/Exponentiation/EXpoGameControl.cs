...
public class EXpoGameControl : MonoBehaviour
{
    GameObject token;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 11 ; i++)
        {
            ...
            var temp = Instantiate(token, new Vector3(
                ...
                Quaternion.identity);
            temp.GetComponent<EXpoMainToken>().faceIndex = faceIndexes[shuffleNum];
        ...
        token.GetComponent<EXpoMainToken>().faceIndex = faceIndexes[0];
    }
