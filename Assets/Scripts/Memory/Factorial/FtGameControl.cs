...
public class FtGameControl : MonoBehaviour
{
    GameObject token;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 11 ; i++)
        {
            ...
            var temp = Instantiate(token, new Vector3(
                ...
                Quaternion.identity);
            temp.GetComponent<FtMainToken>().faceIndex = faceIndexes[shuffleNum];
        ...
        token.GetComponent<FtMainToken>().faceIndex = faceIndexes[0];
    }
